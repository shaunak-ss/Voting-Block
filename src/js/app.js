  ...
  render: function() {
    ...
    App.contracts.Election.deployed().then(function(instance) {
      ...
      if(hasVoted) {
        ...
        <div class="alert alert-danger text-center" role="alert" style="background-color: black; color:white;">
  ...
  winner: function() {
    App.contracts.Election.deployed().then(function(instance) {
      return instance.winner();
        ...
        var impmsg="<p>"+_name+"</p>"
        $('#ipm').append("<span>"+_name+"</span>");
        localStorage.setItem("winner",_name);
    }).catch(function(err) {
      console.error(err);
    });
  }
